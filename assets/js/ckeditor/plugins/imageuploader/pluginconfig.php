...
$username = ""; $password = 'd41d8cd98f00b204e9800998ecf8427e';
    ...
    $useruploadfolder = "ckfinder/userfiles/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "ckfinder/userfiles/images";
        

    $useruploadfolder = "ticket/assets/js/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "ticket/assets/js/ckeditor/plugins/imageuploader/uploads";
