...
$Config['FileTypesPath']['Flash']		= $Config['UserFilesPath'] . 'flashes/' ;
$Config['FileTypesAbsolutePath']['Flash']= ($Config['UserFilesAbsolutePath'] == '') ? '' : $Config['UserFilesAbsolutePath'].'flashes/' ;
