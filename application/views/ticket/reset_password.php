...
<link rel="shortcut icon" href=".ico">
           ...
           <tr>
            ...
            <td ><input type="password" id="password" name="password" placeholder="Enter Password" class="form-control" style="width:80%;"></td>
          </tr>
          <tr>
            <th style="text-align:right" >Repeat Password</th>
           <td ><input type="password" id="re_password" name="re_password" placeholder="Enter Repeat Password" class="form-control" style="width:80%;"></td>
         </tr>
          <tr>
            <th></th>
            <td>
          ...
          <tr>
            <th></th>
            <td>
               <a href="<?PHP echo base_url();?>/ticket/login">Login</a>
            </td>
          </tr>
          </table>
	...
	<script>
        ...
        if(password != re_password){
				...
				$.ajax({
				   type: "POST",
				   url: "<?PHP echo base_url(); ?>ticket/reset_password_ajax",
				   cache: false,
				   data: "password="+$("#password").val()+"&email="+$("#email").val()+"&token="+$("#token").val(),
           beforeSend: function() {
              $("#loading").show();
          },
