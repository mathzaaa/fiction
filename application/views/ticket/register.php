...
#img-upload{
  ...
  <form action="<?PHP echo base_url();?>/ticket/add_register" method="POST" enctype="multipart/form-data" onsubmit="$('#loading').show();">
  ...
  <div class="container">
    ...
    <div>
      <input type="text" placeholder="Name" name="name" style="width:45%" required>
       <input type="text" placeholder="Last Name" name="lname" style="width:45%"  required>
    </div>
    ...
    <label for="email"><b>Major <font color="red">**</font></b></label>
    <p>
    <select id="major" name="major" class="custom-select" style="box-shadow: 0px 0px 25px 0px rgba(50, 50, 50, .5)">
      ...
      <option value="<?PHP echo $row->id_major; ?>"><?PHP echo $row->name_major; ?></option>
      <?php endforeach; ?>
    </select>
    </p>

      <label for="email"><b>Department <font color="red">**</font></b></label>
      <p>
      <select id="department" name="department" class="custom-select" style="box-shadow: 0px 0px 25px 0px rgba(50, 50, 50, .5)">
        ...
        <option value="<?PHP echo $row->id_department; ?>"><?PHP echo $row->name_department; ?></option>
        <?php endforeach; ?>
        </select>
      </p>
    <label>
      <input type="checkbox" name="remember" required style="margin-bottom:15px"> I accept the terms and conditions for signing up to this service
    </label>

    <div class="clearfix">
      <button type="button" id="btn_cancle" class="cancelbtn">Cancel</button>
      <button type="submit" id="btn_add" class="signupbtn">Sign Up</button>
    </div>
  </div>
</form>
