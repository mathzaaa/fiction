...
<link rel="shortcut icon" href=".ico">
           ...
           <tr>
             <th style="text-align:right">THAILAND</th>
            <td ><a href="<?PHP echo base_url(); ?>assets/js/kcfinder/upload/files/TICKET_TH.pdf" target="_blank"><?PHP echo "Download"; ?></a></td>
          </tr>
           <tr>
             <th style="text-align:right">ENGLISH</th>
             <td ><a href="<?PHP echo base_url(); ?>assets/js/kcfinder/upload/files/TICKET_EN.pdf" target="_blank"><?PHP echo "Download"; ?></a></td>
          </tr>
          </table>
