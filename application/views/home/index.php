        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
			<div id="slide_header" class="carousel slide" data-ride="carousel">
			  <ol class="carousel-indicators">
				<li data-target="#slide_header" data-slide-to="0" class="active"></li>
				<li data-target="#slide_header" data-slide-to="1"></li>
				<li data-target="#slide_header" data-slide-to="2"></li>
			  </ol>
			  <div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
				  <img class="d-block img-fluid" src="<?PHP echo base_url(); ?>assets/img/nick-karvounis-78711.jpg" alt="First slide">
				</div>
				<div class="carousel-item">
				  <img class="d-block img-fluid" src="<?PHP echo base_url(); ?>assets/img/nick-karvounis-78711.jpg" alt="Second slide">
				</div>
				<div class="carousel-item">
				  <img class="d-block img-fluid" src="<?PHP echo base_url(); ?>assets/img/nick-karvounis-78711.jpg" alt="Third slide">
				</div>
			  </div>
			  <a class="carousel-control-prev" href="#slide_header" role="button" data-slide="prev">
				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			  </a>
			  <a class="carousel-control-next" href="#slide_header" role="button" data-slide="next">
...
<div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
		...
		<div style="text-align:right;"><a href="#" style="color:red;"><?PHP echo $read_more; ?></a></div>
    </div>
</div>
