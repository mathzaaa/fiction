...
<img src="<?PHP echo base_url(); ?>assets/img/logo.png" class="all-round" width="180px" height="100px">
             <div class="panel-body" align="center">
               ...
               <table border='1' class="table" cellspacing="0"  style="width:50%">
                 <tr>
                  <td >
                      <h3><?PHP echo "You have been unsubscribed";?></h3>
                  </td>
                </tr>
          <tr>
            <td>
              <p>We’re sorry to see you go. If you unsubscribe by accident, please click to button below to subscribe again.</p>
              <p>(เราเสียใจที่คุณได้ยกเลิกรับอีเมลจากเรา ถ้าคุณไม่ได้เจตนายกเลิก ให้คลิกที่ปุ่มด้านล่างนี้เพื่อสมัครรับอีเมลต่ออีกครั้ง)</p>
            </td>
          </tr>
          <tr>
            <td>
              <input type="hidden" id="email" name="email" value="<?PHP echo $this->session->email; ?>">
              <input type="button" class="button button2" id="btn_add" name="btn_add" value="Subscribe me back to list again">
            </td>
          </tr>
          </table>
...
function isValidEmailAddress(emailAddress) {
	...
	<script>
      ...
      $("#btn_add").click(function(){
        ...
        $.ajax({
				   type: "POST",
				   url: "<?PHP echo base_url(); ?>follow/confirm_subscribe_ajax",
				   cache: false,
				   data: "email="+email,
           beforeSend: function() {
              $("#loading").show();
            ...
            if(msg == "Success!!"){
              alert(msg);
              window.location.href="<?php echo base_url('follow/confirm'); ?>";
            }
            else{
              alert(msg);
