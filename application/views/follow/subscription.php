...
<img src="<?PHP echo base_url(); ?>assets/img/logo.png" class="all-round" width="180px" height="100px">
          ...
          <tr>
            <td>
              <p>Email that want to Subscribe</p>
              <p><input type="text" id="email" name="email" class="form-control" > </p>
              <p>(กรุณากรอกอีเมลล์ที่ต้องการรับข่าวสาร)</p>
            </td>
          </tr>
          <tr>
            <td>
...
function isValidEmailAddress(emailAddress) {
	...
	<script>
      ...
      $("#btn_add").click(function(){
        ...
        $.ajax({
				   type: "POST",
				   url: "<?PHP echo base_url(); ?>follow/confirm_unsubscribe",
				   cache: false,
           ...
           beforeSend: function() {
            ...
            if(msg == "Success!!"){
              alert(msg);
              window.location.href="https://www.naraya.com";
            }
            else{
              alert(msg);
