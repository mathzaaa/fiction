...
<img src="<?PHP echo base_url(); ?>assets/img/logo.png" class="all-round" width="180px" height="100px">
             <div class="panel-body" align="center">
               ...
               <table border='1' class="table" cellspacing="0"  style="width:80%">
                 <tr>
                  <td >
                      <h3><?PHP echo "Thank you for subscribed";?></h3>
                  </td>
                </tr>
          <tr>
            <td>
              <p>Your subscription has been confirmed. You've been added to our list and will hear from us soon.</p>
              <p>(ยืนยันการสมัครเรียบร้อย เราได้เพิ่มคุณเข้าไปในรายการและจะติดต่อกลับมาในเร็วๆนี้)</p>
            </td>
          </tr>
          <tr>
            <td>
              <p>For questions about this list, please contact pr@naraya.com</p>
              <p>(หากมีคำถาม สามารถติดต่อเราได้ที่ pr@naraya.com)</p>
            </td>
          </tr>
          </table>
